...
import static field.string.CountingOccurrencesOfACertainCharacter.*;
...
class CountingOccurrencesOfACertainCharacterTest {
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countCommonFirstOption(String, char)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countCommonSecondOption(String, char)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countCommonThirdOption(String, char)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countConsideringUnicodeSurrogatePairs(String, String)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countApacheStringUtilsCountMatches(String, String)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countSpringStringUtilsCountOccurrencesOf(String, String)}
     */
    @Test
    ...
    /**
     * Method under test: {@link CountingOccurrencesOfACertainCharacter#countGuavaCharMatcherCountIn(String, char)}
     */
    @Test
