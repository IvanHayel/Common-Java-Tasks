...
import static field.string.RemovingWhitespaces.removeWhitespacesApache;
import static field.string.RemovingWhitespaces.removeWhitespacesCommon;
import static field.string.RemovingWhitespaces.removeWhitespacesSpring;
...
class RemovingWhitespacesTest {
  ...
  void testRemoveWhitespacesCommon() {
    ...
    log.info("Common: spaces removed - {} took {} ms",
      LARGE_TEXT.length() - largeTextWithoutWhitespaces.length(), (end - start) / 1_000_000);
  }
  ...
  void testRemoveWhitespacesApache() {
    ...
    long end = System.nanoTime();
    log.info("Apache: spaces removed - {} took {} ms",
      LARGE_TEXT.length() - largeTextWithoutWhitespaces.length(), (end - start) / 1_000_000);
  }
  ...
  void testRemoveWhitespacesSpring() {
    ...
    long end = System.nanoTime();
    log.info("Spring: spaces removed - {} took {} ms",
      LARGE_TEXT.length() - largeTextWithoutWhitespaces.length(), (end - start) / 1_000_000);
  }
}