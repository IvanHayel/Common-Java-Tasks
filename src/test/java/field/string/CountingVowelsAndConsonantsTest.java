...
import static field.string.CountingVowelsAndConsonants.countVowelsAndConsonantsFirstOption;
import static field.string.CountingVowelsAndConsonants.countVowelsAndConsonantsSecondOption;
import static field.string.CountingVowelsAndConsonants.countVowelsAndConsonantsThirdOption;
...
class CountingVowelsAndConsonantsTest {
  ...
  /**
   * Method under test:
   * {@link CountingVowelsAndConsonants#countVowelsAndConsonantsFirstOption(String)}
   */
  @Test
  void testCountVowelsAndConsonantsFirstOption() {
    Pair<Integer, Integer> actualCountVowelsAndConsonantsFirstOptionResult = countVowelsAndConsonantsFirstOption(
      "Text");
    ...
    Pair<Integer, Integer> quantityVowelsAndConsonants = countVowelsAndConsonantsFirstOption(
      LARGE_TEXT);
  ...
  /**
   * Method under test:
   * {@link CountingVowelsAndConsonants#countVowelsAndConsonantsSecondOption(String)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link CountingVowelsAndConsonants#countVowelsAndConsonantsThirdOption(String)}
   */
  @Test
